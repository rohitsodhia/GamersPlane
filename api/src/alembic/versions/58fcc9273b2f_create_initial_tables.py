...
Revision ID: 58fcc9273b2f
Revises:
Create Date: 2026-07-04 01:46:49.471002
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("recipient_deleted", sa.DateTime(timezone=True), nullable=True),
        sa.Column("sender_deleted", sa.DateTime(timezone=True), nullable=True),
        sa.Column("history_ids", sa.JSON(), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
